...
class CubeGrid
{
    public:
		...
		//what does ControlNode does? it is a struct representing the vertices of the cubes, with their position, value and whether they are active or not (i.e. above or below the surface level)
